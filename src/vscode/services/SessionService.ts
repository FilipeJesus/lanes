...
import { validateBranchName, ValidationResult } from '../../core/utils';
...
import { ClaudeCodeAgent, CodeAgent } from '../../core/codeAgents';
            ...
            try {
                ...
                if (codeAgent) {
                    ...
                    if (!codeAgent.supportsHooks()) {
                        ...
                        sessionSeed.terminal = TmuxService.isTmuxMode(terminalMode) ? 'tmux' : 'code';
                    }
