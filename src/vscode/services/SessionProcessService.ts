...
import { AgentSessionProvider, getSessionTerminalMode, getSessionAgentName } from '../providers/AgentSessionProvider';
import { CodeAgent, getAgent } from '../../core/codeAgents';
...
export async function processClearRequest(
    ...
    const clearSessionIdImpl = clearSessionIdFn || (async (worktreePath: string) => {
        const { clearSessionId: _clearSessionId } = require('../providers/AgentSessionProvider');
