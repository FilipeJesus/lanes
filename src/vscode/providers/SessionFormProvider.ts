...
import { WorkflowMetadata } from '../../core/workflow';
import { getAvailableAgents, getAgent, DEFAULT_AGENT_NAME } from '../../core/codeAgents';
...
export class SessionFormProvider implements vscode.WebviewViewProvider {
    ...
    private _defaultAgent: string = DEFAULT_AGENT_NAME;
