...
/**
 * Check if tmux mode is enabled via the lanes.terminalMode setting.
 *
 * @returns True if terminal mode is set to 'tmux', false otherwise
 */
export function isTmuxMode(): boolean {
