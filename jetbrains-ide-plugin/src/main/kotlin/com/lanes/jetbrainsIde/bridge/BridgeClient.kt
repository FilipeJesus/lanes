...
class BridgeClient(
    ...
    private fun resolveDefaultBridgeServerPath(): String {
        val plugin = PluginManagerCore.getPlugin(PluginId.getId("com.lanes.jetbrainsIde"))
            ?: throw IllegalStateException("Cannot find Lanes plugin installation")
        return plugin.pluginPath.resolve("jetbrains-ide-bridge").resolve("server.js").toString()
    }
